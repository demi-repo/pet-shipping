          ...
          <div className="flex-row items-center flex">
            ...
            <div className="lg:mx-[60px] lg:my-[60px] w-full lg:max-w-[505px]">
              <div className="flex flex-col gap-[32px]">
                <p className="font-bold	text-[40px]">Create account</p>
                <form>
                  <div className="flex flex-col gap-y-[24px]">
                    ...
                    <div className="flex flex-col gap-y-4">
                      <div className="flex flex-col items-start w-full gap-2">
                        ...
                        <div className="relative justify-start gap-1 w-full flex">
                          <span className="font-medium text-sm">
                            At least 6 characters, 1 uppercase, 1 lowercase, 1
                        ...
                        <div className="w-full">
                          <div className="flex justify-start space-x-2 items-center">
                            ...
                            <div>
                              <span>I agree to the DIY </span>
                              <a className="underline decoration-1 hover:decoration-2 cursor-pointer underline-offset-4">
